...
public interface SavepointManager {
	 ...
	 */
	void rollbackToSavepoint(Object savepoint) throws TransactionException; // 回滚到指定保存点
	 ...
	 */
	void releaseSavepoint(Object savepoint) throws TransactionException;  // 移除保存点
